...
%   Copyright 2018 The MathWorks, Inc.
    ...
    methods
        ...
        function obj = HelperPathAnalyzer(varargin)
            ...
            setProperties(obj,nargin,varargin{:}, 'RefPoses', ...
                'SpeedProfile','Directions', 'Wheelbase');
        end
    end
    ...
    methods(Access = protected)
        ...
        function setupImpl(obj, ~, ~, varargin)
            ...
            if isSimulinkBlock(obj) % In Simulink
                ...
                obj.SpeedProfileInternal = nan(size(varargin{4}), 'like', varargin{4});
            else % In MATLAB
        ...
        function processTunedPropertiesImpl(obj)
            ...
            propChange = isChangedProperty(obj,'RefPoses') || ...
                isChangedProperty(obj,'SpeedProfile') || ...
        ...
        function [refPose, refVel, direction, curvature, varargout] = stepImpl(obj, ...
            ...
            if obj.HasReferenceInports 
                ...
                if ~isequal(obj.RefPosesInternal, varargin{1})
                    ...
                    obj.SpeedProfileInternal = varargin{4};
                ...
                obj.SpeedProfileInternal  = obj.SpeedProfile;
            ...
            endRefVel     = obj.SpeedProfileInternal(currGoalIndex, :);
        ...
        function [refPose, refVel, direction, curvature] = findDesiredPoseAndVelocity(obj, pose)
            ...
            if segClosestPointIndex == 1
                refVel= max(abs(obj.SpeedProfileInternal(obj.ClosestPointIndex)), lowSpeed)*direction;
            else
                refVel= obj.SpeedProfileInternal(obj.ClosestPointIndex)*direction;
            end
    ...
    methods(Access = protected)
        ...
        function s = saveObjectImpl(obj)
            ...
            s.SpeedProfile          = obj.SpeedProfile;
            ...
            s.SpeedProfileInternal  = obj.SpeedProfileInternal;
        ...
        function loadObjectImpl(obj,s,wasLocked)
            ...
            obj.SpeedProfile          = s.SpeedProfile;
            ...
            obj.SpeedProfileInternal  = s.SpeedProfileInternal;
